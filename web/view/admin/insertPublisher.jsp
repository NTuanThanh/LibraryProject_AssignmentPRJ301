    ...
    <body>
        ...
        <nav class="position-edit navbar color-brand navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto flex-column vertical-nav">
                    ...
                    <li class="nav-item left-item">
                        <a class="nav-link" href="insert">Nhà Xuất Bản</a>
                    </li>
                    <li class="nav-item left-item">
          ...
          <form id = "validate-insert-other" action = "insert" method="POST">
                <div class = "insert-book-other">
                    <div class = "insert-book-other-item form-group">
                        <label for="bookname" class="mr-sm-2">Tên Nhà Xuất Bản</label>
                        <input type="text" class="form-control" name ="publisherName" placeholder="Nhập vào tên nhà xuất bản mà bạn muốn thêm" >
                    </div>
                    <div class = "insert-book-other-button">
                        <button id = "btn-Save" class="btn btn-success" type="submit">Thêm</button>
                        <span class = "message-error-book">${requestScope.message_ExistPublisherName}</span>
                    </div>
                </div>             
           </form>
             ...
             <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>${p.name}</td>
                        <td>
                            <button type="button" onclick="deletePublisher(${p.id})" class="btn btn-info">Xóa</button>
                        </td>
                    </tr>
                    </c:forEach>
                </tbody>
        ...
        <script>
            function deletePublisher(pid){
                var c = confirm("Bạn có chắc muốn xóa nhà xuất bản này không ?");
                if(c){
                   window.location.href = "delete?pid=" + pid;
                } 
            }
             // có sách mới phân trang 
            if(${requestScope.publishers.size() > 0}){
